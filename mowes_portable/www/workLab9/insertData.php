<?php
    ...
    echo " <h2 style=\"text-align: center\"> Insert data for the table $tableName </h2>
    <form action=\"http://localhost/workLab9/insertSuccessfully.php?table=$tableName\" method=\"post\">
        <table>
            <colgroup>
                <col style=\"width: 30%\">
            </colgroup>";
